...
st.markdown("""
    ...
    /* Hide the default download button icon to make it cleaner */
...
# --- 3. HELPER: CREATE TEXT FILE ---
def create_lesson_file(data):
    """Formats the JSON lesson into a nice printable text string."""
    ...
    for chunk in data.get('story', []):
        if isinstance(chunk, dict):
            ...
            # ADDED: English translation for the story
